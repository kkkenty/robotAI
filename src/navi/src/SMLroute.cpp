...
const double goal[pt][2] = {{1.4, -0.4}, {3.2, -0.4}, {3.7, -0.9}, {3.7, -1.8}, {3.2, -2.3}, {1.25, -2.3},  // 1個目
                            {0.75, -1.8}, {0.75, -0.9}, {1.25, -0.4}, {3.2, -0.4}, {3.7, -0.9}, {3.7, -1.8}, {3.2, -2.3}, {1.4, -2.3},  // 2個目
                            {0.8, -1.8}, {0.85, -0.4}, {4.1, -1.05}, {3.5, -2.25}, {0.5, -1.0}, {0.65, -0.4}};  // 3個目
